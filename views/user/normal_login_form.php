...
<form class="mwpl-form-wrapper mwpl-login-form <?php echo implode(' ', apply_filters('mwpl_login_form/form_classes', []))?>" method="post">
    ...
    <div class="mwpl-form-fields">
        <div class="mwpl-input-item">
            <label for="username">
                ...
                <span class="mwpl-field">
                    ...
                    <span class="mwpl-label-value"><?php echo apply_filters('mwpl_login_form_username_field_label_value', __('Username', 'mihanpanel'))?></span>
                </span>
        ...
        <div class="mwpl-input-item">
            <label for="password">
                ...
                <span class="mwpl-field">
                    ...
                    <span class="mwpl-label-value"><?php echo apply_filters('mwpl_login_form_password_field_label_value', __('Password', 'mihanpanel')); ?></span>
                </span>
        ...
        <div class="mwpl-input-item mwpl-spinner-field">
            <input type="submit" name="login" value="<?php echo apply_filters('mwpl_login_form_login_button_text_value', __('Login', 'mihanpanel'))?>">
